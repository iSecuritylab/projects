            ...
            <div class="container">
                <div class="hero-content">
                    <div class="section-heading">
                        ...
                        <p class="section__desc text-white pb-4">Welcome to iCreate Academy,<br>where learning is not just a process but a thrilling exploration of your passions.
        ...
        <div class="hero-slider-item hero-bg-2">
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-65 lh-80 pb-3">Join iCreate Academy & Get <br> Your Free Courses!</h2>
                        <p class="section__desc text-white pb-4">Embark on a transformative experience with us, breaking free from the constraints of conventional learning.
            ...
            <div class="container">
                <div class="hero-content text-right">
                    <div class="section-heading">
                        ...
                        <p class="section__desc text-white pb-4">We go beyond the industry standards,<br> guiding you towards discovering and mastering what you truly love.
                        </p>
                    </div>
