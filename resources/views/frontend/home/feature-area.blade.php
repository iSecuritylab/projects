        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Embark on your Learning Journey with Confidence as our Handpicked team of Expert Teachers Guide you Through a World of Knowledge and Skill Development.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">We Prioritize Easy Communication for a Seamless Learning Experience. Our Commitment to Fostering an Open and Collaborative Environment ensures that Communication flows Effortlessly between Students and Educators.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">We Believe in Recognizing your Accomplishments. As you Progress Through our Courses, you Have the Opportunity to Earn Valuable Certificates that Validate your Newfound Skills and Knowledge.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
