            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Teach what you love. iCreate Academy gives you the tools to create a course.</p>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">iCreate Academy for Business</h5>
